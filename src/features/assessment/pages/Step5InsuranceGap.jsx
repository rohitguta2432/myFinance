...
import { ArrowRight, Shield, HeartPulse, Edit2, AlertTriangle, CheckCircle, CheckCircle2, Info, Loader2 } from 'lucide-react';
...
const Step5InsuranceGap = () => {
    ...
    const handleNext = async () => {
        if (!insurance.hasLifeInsurance && !insurance.hasHealthInsurance) {
            toast('💡 Tip: Review your insurance coverage for a complete assessment', { id: 'step5-guide' });
        }
        try {
